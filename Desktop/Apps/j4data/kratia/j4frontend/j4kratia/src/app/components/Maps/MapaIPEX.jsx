...
export default function MapIPEX({vigencia, geojson}) {
    ...
    const MyDataIPEX = () => {
        ...
        const geojsonObject = L.geoJSON(geojson, {
           ...
           <div class="card-body">
             ...
             <table class="table table-hover table-inverse table-responsive">
                ...
                let ToolTip = `${features.properties.NOMBRE} <br/> IPM: ${formatter.format(features.properties.RESULTADO)}<br/> 
        ...
        info.update = function (props) {
            this._div.innerHTML = ` <h5>IPEX por Comunas/Corregimientos <br />${vigencia}</h5>`
        };
