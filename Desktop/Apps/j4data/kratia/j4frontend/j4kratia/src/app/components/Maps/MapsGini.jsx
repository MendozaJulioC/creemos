...
export default function MapGini({vigencia, geojson}) {
    ...
    const MyDataGini = () => {
        ...
        const geojsonObject = L.geoJSON(geojson, {
           ...
           <div class="card-body">
             ...
             <table class="table table-hover table-inverse table-responsive">
                ...
                let ToolTip = `${features.properties.NOMBRE} <br/> Gini: ${formatter.format(features.properties.RESULTADO)}<br/> 
        ...
        info.update = function (props) {
            this._div.innerHTML = ` <h5>Gini por Comunas/Corregimientos <br />${vigencia}</h5>`
        };
        ...
        //     this._div.innerHTML += ' <p>  <b>  Rango IPEX </b></p>'
