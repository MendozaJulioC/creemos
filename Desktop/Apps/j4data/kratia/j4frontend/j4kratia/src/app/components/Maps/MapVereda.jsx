...
const MyDataVeredas= ()=>{
  ...
  useEffect(()=>{
    ...
    if (geojson){
        ...
        onEachFeature: function (features, layer) {
         ...
         <div class="card-body">
            <h5 class="card-title">` + features.properties.NOMBRE + `</h5>
                    <h6 class="card-subtitle mb-2 text-muted">  ${features.properties.CODCOMUNA} - ${features.properties.NOM_COMUNA}  </h6>
            <p class="card-text">
            ...
            <table class="table table-hover table-inverse table-responsive">
              <tbody>
                ...
                <tr>
                   <td>Mts.<sup>2</sup></td>
                    <td>` + features.properties.AREAM2 + `</td>
                </tr>
      ...
      //   this._div.innerHTML='<p><b> <h3> División Política Distrito Medellín </h3><b></>'
      // }
      //info.addTo(map)
...
export default function MapVereda(props) {
