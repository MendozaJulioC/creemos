...
export default function MapIPM({vigencia, geojson}) {
    ...
    const MyDataIMCV = () => {
        ...
        info.update = function (props) {
            this._div.innerHTML = ` <h5>IPM por Comunas/Corregimientos <br />${vigencia}</h5>`
        };
        ...
        legend.onAdd = function (map) {
            ...
            this._div.innerHTML += ' <p>  <b>  Rango IPM </b></p>'
